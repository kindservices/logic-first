...
package object goldenlayout {
  ...
  /**
    * We can't add this directly to a js.Object which isn't a js.native thing,
    * so we do it via an extension method here
    */
  extension (myLayout: GoldenLayout) {


    /**
      * Convenience method to create a new UIComponent (globally registered) and draggable menu item.
      * 
      ...
      *
      * @param navigation the place where we'll append our new menu item 
      * @param title the title of the menu item
      * @param initialState the initial state of the component. This will be updated with a 'title' and 'id' field
      * @param menuItem the menu item to add (null defaults to a new li element with the title as text)
      * @param render the function which will draw the body of the component
      */
    def addMenuItem(
        navigation: Node,
        title: String,
